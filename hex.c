...
/**
 * p_lowhex - writes unsigned integer to buffer in base hexidecimal lowercase
 * @inv: the arguments inventory with most commonly used arguments
 */
...
/**
 * p_uphex - writes unsigned integer to buffer in base hexidecimal uppercase
 * @inv: the arguments inventory with most commonly used arguments
 */
...
/**
 * p_longuphex - writes unsigned long integer in base hexidecimal uppercase
 * @inv: the arguments inventory with most commonly used arguments
 */
